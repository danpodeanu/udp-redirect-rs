#!/usr/bin/env bash
# Quick functional tests for udp-redirect-rs.
# Requires: nc (netcat-openbsd), cargo
...
# --- Build Rust ---
echo "=== build Rust ==="
cargo build -q && pass "build Rust" || { echo "FAIL: build Rust (aborting)"; exit 1; }
...
run_tests ./target/debug/udp-redirect-rs 0
